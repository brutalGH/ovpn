...
wget -O /etc/systemd/system/ws-openssh.service https://raw.githubusercontent.com/brutalGh/ovpn/main/insshws/ws-openssh.service && chmod +x /etc/systemd/system/ws-openssh.service

#System Dropbear Websocket-SSH Python
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/brutalGh/ovpn/main/insshws/ws-dropbear.service && chmod +x /etc/systemd/system/ws-dropbear.service
