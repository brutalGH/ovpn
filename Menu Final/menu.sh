...
Name=$(curl -sS https://raw.githubusercontent.com/brutalGH/ovpn/main/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/brutalGH/ovpn/main/permission/ip | grep $MYIP | awk '{print $3}')
