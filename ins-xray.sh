...
# install nginx
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/brutalGh/ovpn/main/vps.conf.txt"
sleep 1
...
sleep 1 
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/brutalGh/ovpn/main/conf/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/brutalGh/ovpn/main/conf/xray.conf"
